            ...
            <div class="col-sm-6 leftColumn">
              <form action="#" method="get" id="postSubmission">
                <div class="form-group">
                  <label for="postTitle">
                    <h6 class="labelFontSize">Title</h6>
                  </label>
                  <input
                    type="text"
                    class="form-control"
                ...
                <div class="form-group">
                  <label for="postDescription">
                    <h6 class="labelFontSize">Description</h6>
                  </label>
                  <textarea
                    class="form-control"
                    id="postDescription"
                ...
                <div class="form-group">
                  <label for="option1">
                    <h6 class="labelFontSize">Option 1</h6>
                  </label>
                  <textarea
                    class="form-control"
                    id="option1"
                ...
                <div class="form-group">
                  <label for="postDescription">
                    <h6 class="labelFontSize">Option 2</h6>
                  </label>
                  <textarea
                    class="form-control"
                    id="option2"
                ...
                <div class="form-group">
                  <label for="postDescription">
                    <h6 class="labelFontSize">Option 3</h6>
                  </label>
                  <textarea
                    class="form-control"
                    id="option3"
